...
import type { Language as _Language, ShortProfile as _ShortProfile, Status as _Status, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createUserProfile(arg0: ShortProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createUserProfile(to_candid_ShortProfile_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurrentActiveParticipants(): Promise<Array<[Principal, Status]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentActiveParticipants();
    ...
    async getMatches(): Promise<Array<MatchAction>> {
        if (this.processError) {
            try {
...
function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    sentMatchRequests: Array<Principal>;
    matches: Array<Principal>;
    nativeLanguages: Array<_Language>;
    targetLanguages: Array<_Language>;
    lastActive: bigint;
    ...
    return {
        ...
        sentMatchRequests: value.sentMatchRequests,
        matches: value.matches,
        nativeLanguages: value.nativeLanguages,
        targetLanguages: value.targetLanguages,
        lastActive: value.lastActive,
        currentStatus: from_candid_Status_n17(_uploadFile, _downloadFile, value.currentStatus),
        lastMessageCheck: value.lastMessageCheck,
        receivedMatchRequests: value.receivedMatchRequests
    };
}
...
function from_candid_tuple_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [Principal, _Status]): [Principal, Status] {
    return [
        value[0],
        from_candid_Status_n17(_uploadFile, _downloadFile, value[1])
    ];
}
function from_candid_variant_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "active" in value ? Status.active : "offline" in value ? Status.offline : value;
}
...
function from_candid_vec_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<[Principal, _Status]>): Array<[Principal, Status]> {
    return value.map((x)=>from_candid_tuple_n22(_uploadFile, _downloadFile, x));
}
function to_candid_ShortProfile_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ShortProfile): _ShortProfile {
...
function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        nativeLanguages: value.nativeLanguages,
        targetLanguages: value.targetLanguages,
        currentStatus: to_candid_Status_n12(_uploadFile, _downloadFile, value.currentStatus)
    };
}
